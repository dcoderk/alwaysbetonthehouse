...
function property_listings_register_blocks() {
	...
	$simple_card_editor_js_path       = get_theme_file_path( '/blocks/simple-card/editor.js' );
	...
	wp_register_script(
		'property-listings-simple-card-editor',
		get_theme_file_uri( '/blocks/simple-card/editor.js' ),
		array( 'wp-blocks', 'wp-block-editor', 'wp-components', 'wp-element', 'wp-i18n' ),
		file_exists( $simple_card_editor_js_path ) ? filemtime( $simple_card_editor_js_path ) : null,
		true
	);
	...
	register_block_type( get_theme_file_path( '/blocks/simple-card' ) );
}
